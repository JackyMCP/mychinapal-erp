...
export default function TabDokumenty({ documents }) {
  ...
  if (documents.length === 0) return <div style={{ fontSize: 11, color: C.muted }}>Brak dokumentów — pliki wysłane na czacie tego klienta pojawią się tutaj automatycznie.</div>
